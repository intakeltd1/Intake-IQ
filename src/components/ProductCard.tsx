...
export function ProductCard({ product, isTopValue, isFeatured, isPopular, isTopValueOfDay }: ProductCardProps) {
  ...
  // Toggle to show value bar on all tiles
  ...
  const cardContent = (
    <>
      ...
      {/* ZONE 2 & 3: Content Area - Fixed layout, no dynamic resizing */}
  ...
  return (
    <>
      <Card 
        ref={cardRef}
        className={`h-[340px] sm:h-[380px] md:h-[420px] group ${getBorderClass()} ${
